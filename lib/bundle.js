...
/***/ function(module, exports, __webpack_require__) {
	...
	const Asteroid = __webpack_require__(11);
	const Ship = __webpack_require__(15);
	const Blaster = __webpack_require__(16);
	const PowerUp = __webpack_require__(17);
	const Background = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const MovableObject = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Asteroid = __webpack_require__(11);
	const PowerUp = __webpack_require__(17);
	const Sprite = __webpack_require__(14);
	    ...
	    for (let i = 0; i < game.blasters.length; i++) {
	      for (let j = 0; j < game.asteroids.length; j++) {
	        if (this.isCrash(game.blasters[i], game.asteroids[j])) {
	          ...
	          game.asteroids[j].path = 'assets/sprites/explosion2.png';
	          window.setTimeout(() => {
	  ...
	  applyPowerUp(game) {
	    if (this.powerUpNum === 0) {
	      ...
	      for (let i = 0; i < game.asteroids.length; i++) {
	        game.asteroids[i].path = 'assets/sprites/explosion2.png';
	        window.setTimeout(() => {
